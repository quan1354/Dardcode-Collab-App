...
Future<Map<String, dynamic>> fetchUser() async {
  try {
    final response = await http.get(
      ...
      headers: {'Authorization': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImtpZCI6IjMifQ..uSGeu5v2lScd4PjN6Q-8MJONfX3bYaLCQxidMW3YQF0'},
    );
